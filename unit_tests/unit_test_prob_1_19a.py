...
accept_file = open("unit_tests/inputs/1_19a_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_19a_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_19a import prob_1_19a
test_machine = prob_1_19a
...
with open("prob_1_19a.py","r") as file:
    for line in file:
