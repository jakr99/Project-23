...
accept_file = open("unit_tests/inputs/1_6k_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_6k_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_18k import prob_1_18k
test_machine = NFA.from_regex(prob_1_18k, input_symbols={'0', '1'})
...
with open("prob_1_18k.py","r") as file:
    for line in file:
