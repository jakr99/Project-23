...
accept_file = open("unit_tests/inputs/1_6a_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_6a_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_18a import prob_1_18a
test_machine = NFA.from_regex(prob_1_18a, input_symbols={'0', '1'})
...
with open("prob_1_18a.py","r") as file:
    for line in file:
