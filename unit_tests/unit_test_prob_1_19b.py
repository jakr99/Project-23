...
accept_file = open("unit_tests/inputs/1_19b_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_19b_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_19b import prob_1_19b
test_machine = prob_1_19b
...
with open("prob_1_19b.py","r") as file:
    for line in file:
