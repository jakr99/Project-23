...
accept_file = open("unit_tests/inputs/1_19c_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_19c_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_19c import prob_1_19c
test_machine = prob_1_19c
...
with open("prob_1_19c.py","r") as file:
    for line in file:
