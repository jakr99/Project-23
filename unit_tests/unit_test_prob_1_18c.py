...
accept_file = open("unit_tests/inputs/1_6c_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_6c_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_18c import prob_1_18c
test_machine = NFA.from_regex(prob_1_18c, input_symbols={'0', '1'})
...
with open("prob_1_18c.py","r") as file:
    for line in file:
