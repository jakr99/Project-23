...
accept_file = open("unit_tests/inputs/1_6h_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_6h_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_18h import prob_1_18h
test_machine = NFA.from_regex(prob_1_18h, input_symbols={'0', '1'})
...
with open("prob_1_18h.py","r") as file:
    for line in file:
